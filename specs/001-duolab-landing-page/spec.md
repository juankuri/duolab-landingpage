...
- The lab's real WhatsApp number has been confirmed by the client (+52 938 115 6464, Ciudad del Carmen / Campeche) and MUST be used in all CTA links; no placeholder number reaches production.
