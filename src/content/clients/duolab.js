...
const content = {
  ...
  seo: {
    title:
      "DúoLab — Laboratorio de análisis clínicos en Ciudad del Carmen, sin cita",
    description:
  ...
  hero: {
    eyebrow: "11 años cuidando la salud de Ciudad del Carmen",
    headline: "Tus análisis clínicos, con resultados en los que confías.",
    subheadline:
  ...
  solution: {
    ...
    childCareDifferentiator: {
      ...
      ctaLabel: "Escríbenos antes de venir, te explicamos cómo prepararlo",
    },
  },
};
